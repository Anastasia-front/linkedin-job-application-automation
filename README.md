...
- [`n8n-version.txt`](n8n-version.txt) — pinned n8n version, kept current automatically by [`.github/workflows/update-n8n-version.yml`](.github/workflows/update-n8n-version.yml)
- [AWS production deployment guide](docs/aws-production-deployment.md) (includes [workflow seeding](docs/aws-production-deployment.md#workflow-seeding) and [keeping n8n updated](docs/aws-production-deployment.md#keeping-n8n-updated))
